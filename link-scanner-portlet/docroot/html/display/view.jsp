...
<p>	Select the content type to process for links.</p>

<liferay-portlet:renderURL varImpl="extractLinksURL" escapeXml="false" >
	<portlet:param name="mvcPath" value='<%= templatePath + "scanner.jsp" %>' />
</liferay-portlet:renderURL>

<aui:form action="<%= extractLinksURL.toString() %>" method="get" name="fm" id="fm">
...
<aui:script>
	function <portlet:namespace />extractLinks() {
		...
		debugger;
		document.getElementById("_linkscanner_WAR_linkscannerportlet_fm").submit();
